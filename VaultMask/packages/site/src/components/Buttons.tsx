...
export const SendTxButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Send Tx</Button>;
};
...
export const RecScreenButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Start</Button>;
}

export const GetFileButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Get File</Button>;
}